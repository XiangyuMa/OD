...
public class 射击成绩 {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> ids = toIntList(scanner.nextLine());
        List<Integer> scores = toIntList(scanner.nextLine());
        scanner.close();
    ...
    private static Integer sumT3(List<Integer> value) {
    ...
    private static List<Integer> toIntList(String nextLine) {
        return Arrays.stream(nextLine.split(",")).map(Integer::parseInt).collect(Collectors.toList());
    }
